export default function SuperDashboardui() {
  const userName = "Anurag";
  const hospitalName = "Hospital name";
  const Authority = "SuperAdmin";
      ...
      <div className="flex w-screen h-screen text-gray-700">
        ...
        <div className="flex flex-col w-56 border-r border-gray-300">
          ...
          <div className="flex flex-col flex-grow p-4 overflow-auto">
            <a className="text-center w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600" href="/superadmin/Registration">
              CREATE
            </a>
            <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">
              Update
            </button>
            <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">
              Delete
        ...
        <div className="flex flex-col flex-grow">
          <div className="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
            <span className=" inline-flex gap-8">
              ...
              <h1 className="text-sky-500 text-lg font-medium">{hospitalName}</h1>
              <h1 className="text-sky-500 text-lg font-medium">{Authority}</h1>
            </span>
