    ...
    <div>
      <div className="flex w-screen h-screen text-gray-700">
        <div className="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300 ">
          ...
          {/* other components like crud actions  */}
          <a
        ...
        <div className="flex flex-col w-56 border-r border-gray-300">
          ...
          {/* Current Option functions like for admin dashboard what a user want either to create a patient record or view previous record */}
          <div className="flex flex-col flex-grow p-4 overflow-auto">
            
              <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">CREATE</button>
              <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">Read</button>
              <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">Update</button>
              <button className=" w-full rounded-lg text-sky-600 hover:outline outline-1 outline-sky-600">Delete</button>
        ...
        <div className="flex flex-col flex-grow">
          <div className="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
            <span className=" inline-flex gap-8">
              <h1 className="text-sky-500 text-lg font-medium">{userName}</h1>
              <h1 className="text-sky-500 text-lg font-medium">
                {hospitalName}
              </h1>
            </span>

            <button className="flex items-center justify-center h-10 px-4 ml-auto text-sm font-medium hover:text-sky-700 bg-red-600 rounded hover:bg-red-800">
              Logout
            </button>
          ...
          <div className="flex-grow p-6 overflow-auto bg-gray-200">
            {/* column grid id ont how can i use it 
